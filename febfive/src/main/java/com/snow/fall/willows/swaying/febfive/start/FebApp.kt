...
import com.snow.fall.willows.swaying.febfive.utils.AdShowFun
import com.snow.fall.willows.swaying.febfive.utils.AdUtils
import com.snow.fall.willows.swaying.febfive.utils.H5Limiter
import com.snow.fall.willows.swaying.febfive.utils.KeyContent
import com.snow.fall.willows.swaying.febfive.utils.KeyContent.KEY_IS_ADMIN_DATA
import com.snow.fall.willows.swaying.febfive.utils.KeyContent.KEY_IS_ANDROID
import com.snow.fall.willows.swaying.febfive.utils.KeyContent.KEY_IS_INT_JSON
import com.snow.fall.willows.swaying.febfive.utils.KeyContent.KEY_IS_REF
            ...
            override fun run() {
                ...
                FebGetAllFun.postAdminData(callback = object : FebGetAllFun.CallbackMy {
                    override fun onSuccess(response: String) {
                        ...
                        // 如果配置变为 A，停止重试
                        if (updatedAdminData?.canNext == true) {
