...
class AdLimiter {
    ...
    private fun maxHourlyShows() {
        ...
        val dataString =
            jsonBean.timeCanNext.split("-") ?: listOf("0", "0", "0", "0", "1", "1", "1")
        MAX_HOURLY_SHOWS = dataString[4].toInt()
        MAX_DAILY_SHOWS = dataString[5].toInt()
        MAX_DAILY_CLICKS = dataString[6].toInt()
    }
